...
insuffisant, veuillez vérifier vos achats.</div>';
                ...
                $contenu .= '<div class="erreur">l\'produit ' . $_SESSION['panier']['id_produit'][$i] . ' à été retiré de votre panier car nous sommes en
rupture de stock, veuillez vérifier vos achats.</div>';
    ...
    if (!isset($erreur)) {
        ...
        mail(
            ...
            "Merci votre n° de suivi est le $id_commande",
